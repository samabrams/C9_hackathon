/** GLOBAL VARIABLES*/
var optionsArray = []; //stores option divs until length of array is 2
var morningActivityChoice; //choice made by user for morning activity
var beverageChoiceResult; //result of choice made by user for morning beverage
var nightDrinksResult; //result of choice made by user for night drinking
var mainTextDivBottom; //base container for main text of game
var option1OuterLabelDiv, option2OuterLabelDiv, option1InnerLabelDiv, option2InnerLabelDiv; //divs for option labels
var question, option1, option2, option1ChosenText, option2ChosenText; //variables for game functions
var partnerChoiceSubjPron, partnerChoiceSubjPronCap, partnerChoiceObjPron, partnerChoicePossPron; //variables for user's partner choice effects
...
var nextFunction; //which function will run next
var place;//stores the randomly picked object from results generated by the googleTextSearch function
var placeName; //variable that stores the name property of the selected Google place
var placeNameDiv;//dom element container for placeName 
var placeImageURL;//variable that stores the url of the selected Google place photo
var placeImage;//dom element for the Google place photo
var placeDiv;//dom element container for placeName and placeImage
var flickrImage;//dom element for Flicker image
var songArray = []; 
...
/** Assign the avatar when the user click it */
...
$(document).ready(function () {
    listenAjax();
    $('#playButton').click(playPause);       // button listen/pause the music
    $('.startButton').click(function () {    // button start the game
    ...
    initializeMap();
    poweredByGoogle();
    $(".avatarDiv").click(avatarClicked);   // click handler chose your avatar
});

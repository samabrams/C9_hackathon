...
function buildTemplate(){
    ...
    option1LabelDiv = $('<div>').addClass('innerTextDiv innerTextDivSmall col-xs-10');
    option2LabelDiv = $('<div>').addClass('innerTextDiv innerTextDivSmall col-xs-10');
...
function breakfastTime(){
    ...
    var option1 = $('<p>').text('Eggs at ');
    var option2 =  'Pancakes at ';
